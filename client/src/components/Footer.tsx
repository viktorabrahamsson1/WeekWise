function Footer() {
  return (
    <div className="mt-auto bg-indigo-500 px-4 py-3 duration-150 dark:bg-slate-800 dark:text-gray-300 ">
      <div className="container mx-auto flex items-center justify-center gap-3 text-xs text-blue-800 dark:text-gray-300 sm:text-sm md:text-base">
